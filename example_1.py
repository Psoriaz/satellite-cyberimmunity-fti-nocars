...
if __name__ == '__main__':
    ...
    drawer_q.put(Event(None, 'orbit_drawer', 'draw_restricted_zone', RestrictedZone(10, -10, 20, 20)))
    drawer_q.put(Event(None, 'orbit_drawer', 'draw_restricted_zone', RestrictedZone(50, -100, 80, -60)))
